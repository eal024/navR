...
#                        public = list(
#                            initialize = function( name, ar = NULL,
#                                                   regnskap_ifjor = NULL,
#                                                   vekst_ytelse = NULL,
#                                                   prisvekst = NULL,
#                                                   volumvekst = NULL,
...
#                                                  as.character( ((private$underregulering-1)*100) %>% format(digits = 2)),
#                                                  as.character((round( (private$tiltak-1) *100, digits = 2 ) )) %>% format(digits = 2) ),
...
#                                                        # Prisvekst: Skal egentlig ta med seg tiltak.
...
#                                                        ( private$regnskap_ifjor + private$regnskap_ifjor*(private$volumvekst-1) + private$regnskap_ifjor*(private$vekst_ytelse-1) + private$regnskap_ifjor*(private$prisvekst-1) )*(private$underregulering-1),
#                                                        # Tiltak
#                                                        ( private$regnskap_ifjor + private$regnskap_ifjor*(private$volumvekst-1) + private$regnskap_ifjor*(private$vekst_ytelse-1) + private$regnskap_ifjor*(private$prisvekst-1) + private$regnskap_ifjor*(private$underregulering-1) )*(private$tiltak-1)
#                                              )
#                                )
#
