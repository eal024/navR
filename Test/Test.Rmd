...
regnskap_feb <- navR::regnskap %>% filter( dato < lubridate::ymd("2020-10-01")) %>% arrange( desc(dato))
mottakere_feb <- navR::mottakere %>% filter( dato < lubridate::ymd("2020-10-01"))%>% arrange( desc(dato))
...
# Regnskapstabell
tabell2 <- bud$lagRegnskapTabell2( anslag1 = nytt2020 ,
                                   anslag2 = nytt2021      ) %>%
